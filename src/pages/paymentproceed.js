                ...
                <Row className="profile-container">
                  ...
                  <Col className="payment-details">
                    ...
                    <Row className="card-number">
                      <Col md={4}  > <Form.Control className="card-number" type="text" placeholder="Card Number" /></Col>
                      <Col md={4} > <Form.Control  className="three-digit" type="text" placeholder="Three Digit Number" /></Col>
                    </Row>
                    <br />
