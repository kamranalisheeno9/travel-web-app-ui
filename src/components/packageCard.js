          ...
          <Container className="card-package">
            ...
            <Card className="card-container">
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item className="pkg-include">CT01 </ListGroup.Item>
          ...
          <Container className="card-package">
            ...
            <Card className="card-container">
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item className="pkg-include">CT02 </ListGroup.Item>
          ...
          <Container className="card-package">
            ...
            <Card className="card-container">
              ...
              <ListGroup variant="flush">
                ...
                <ListGroup.Item className="pkg-include">CT03 </ListGroup.Item>
